 ...
 *   https://datatables.net/download/#bs5-5.3.0/jq-3.7.0/dt-2.3.5
 *
 * Included libraries:
 *   Bootstrap 5 5.3.0, jQuery 3.7.0, DataTables 2.3.5
 */
...
(n => {
    ...
    var C, X, r, e, V = function (e, P) {
            ...
            builder: "bs5-5.3.0/jq-3.7.0/dt-2.3.5",
            buttons: {},
            ccContent: {},
            classes: {},
            errMode: "alert",
    ...
    function re(e) {
        (t => {
            if (t.oFeatures.bAutoWidth) {
                    ...
                    if (!n.wideStrings) {
                        for (var r = [], a = [], o = 0, i = e.aiDisplayMaster.length; o < i; o++) {
                            var l = e.aiDisplayMaster[o], l = xe(e, l)[t],
                                ...
                                l = (l = l.replace(/id=".*?"/g, "").replace(/name=".*?"/g, ""), I(l).replace(/&nbsp;/g, " "));
                        ...
                        }), s.length && n.wideStrings.push(s[0]), 1 < s.length && n.wideStrings.push(s[1]), 2 < s.length && n.wideStrings.push(s[3])
                    }
                ...
                a.style.width = L(S), h.remove(), c && (a.style.width = L(c)), !c && !s || t._reszEvt || (D = V.util.throttle(function () {
                    var e = $e(t);
    ...
    function x(e, t) {
        if (a = "ssp" == J(s = e), void 0 !== (i = s.iInitDisplayStart) && -1 !== i && (s._iDisplayStart = !a && i >= s.fnRecordsDisplay() ? 0 : i, s.iInitDisplayStart = -1), -1 !== G(e, "aoPreDrawCallback", "preDraw", [e]).indexOf(!1)) S(e, !1); else {
            ...
            if (e.bDrawing = !0, e.deferLoading) e.deferLoading = !1, e.iDraw++, S(e, !1); else if (a) {
                if (!e.bDestroying && !t) return 0 === e.iDraw && c.empty().append(Le(e)), (l = e).iDraw++, S(l, !0), void Oe(l, (t => {
                    function n(e, t) {
    ...
    function Ne(t) {
        ...
        if (t.nTableWrapper = r[0], t.sDom) for (var a, o, i, l, s, u, c = t, e = t.sDom, d = r, f = e.match(/(".*?")|('.*?')|./g), h = 0; h < f.length; h++) a = null, "<" == (o = f[h]) ? (i = H("<div/>"), "'" != (l = f[h + 1])[0] && '"' != l[0] || (l = l.replace(/['"]/g, ""), s = "", -1 != l.indexOf(".") ? (u = l.split("."), s = u[0], u = u[1]) : "#" == l[0] ? s = l : u = l, i.attr("id", s.substring(1)).addClass(u), h++), d.append(i), d = i) : ">" == o ? d = d.parent() : "t" == o ? a = Ue(c) : V.ext.feature.forEach(function (e) {
            ...
            var n = Ae(t, t.layout, "top"), e = Ae(t, t.layout, "bottom"), p = ot(t, "layout");
    ...
    function Oe(n, e, r) {
        ...
        H.isPlainObject(o) && H.extend(l, o), n.oAjaxData = e, G(n, null, "preXhr", [n, e, l], !0), "json" === l.submitAs && "object" == typeof e && (l.data = JSON.stringify(e)), "function" == typeof o ? n.jqXHR = o.call(i, e, t, n) : "" === o.url ? (je(n, i = {}, []), t(i)) : n.jqXHR = H.ajax(l), a && (o.data = a)
    }
    ...
    function Dt(i, e, l) {
        var s, u, c = i.aoColumns, d = (e => {
            ...
            var t, a, o = "string" == typeof n ? n.match(At) : "";
            if (o) switch (o[2]) {
                case"visIdx":
                case"visible":
    ...
    }, It = "row().child", Lt = It + "()", At = (r(Lt, function (e, t) {
        var n = this.context;
    ...
    r("cells()", function (g, e, m) {
        ...
        return H.isPlainObject(g) && (void 0 === g.row ? (m = g, g = null) : (m = e, e = null)), H.isPlainObject(e) && (m = e, e = null), null == e ? this.iterator("table", function (e) {
            return r = e, e = g, t = pt(m), d = r.aoData, f = wt(r, t), n = A(v(d, f, "anCells")), h = H(Z([], n)), p = r.aoColumns.length, ht("cell", e, function (e) {
    ...
    }), V.version = "2.3.5", V.settings = [], V.models = {}, V.models.oSearch = {
        caseInsensitive: !0,
        search: "",
        regex: !1,
        smart: !0,
...
(n => {
    ...
    }) : "object" == typeof exports ? (o = require("jquery"), a = function (t, e) {
