...
((year(kh.ngay_sinh) <= year(curdate()) - 17 and month(kh.ngay_sinh) <= month(curdate()) and day(kh.ngay_sinh) <= day(curdate()))  
or year(kh.ngay_sinh) <= year(curdate()) - 18)
and ((year(kh.ngay_sinh) >= year(curdate()) - 49 and month(kh.ngay_sinh) >= month(curdate()) and day(kh.ngay_sinh) >= day(curdate()))  
...
where month(hd.ngay_lam_hop_dong)
